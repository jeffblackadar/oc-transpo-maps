...
genMapHTMLScriptTop<-function(outputFileHtmlCon, mapYear) {  
  writeLines(paste0('  <p>',genPageTitle(mapYear),' | <a href="https://github.com/jeffblackadar/oc-transpo-maps/blob/master/oc_tips.md">Usage tips</a>. | *Draft*</p>'), outputFileHtmlCon)
