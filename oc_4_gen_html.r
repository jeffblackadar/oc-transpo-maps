...
for (generateYear in 1961:1976){
  ...
  if (nrow(output_dbRows)==0){
    ...
    writeLines('  <p><a href="https://github.com/jeffblackadar/oc-transpo-maps/blob/master/oc_tips.md">Instructions</a>: Click on map features. Scroll down. | <a href="https://github.com/jeffblackadar/oc-transpo-maps/blob/master/oc_about.md">About the project</a></p>', outputFileHtmlCon)
